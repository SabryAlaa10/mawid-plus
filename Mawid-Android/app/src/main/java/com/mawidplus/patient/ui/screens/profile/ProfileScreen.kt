...
fun ProfileScreen(
    ...
    var themePreference by remember {
        mutableStateOf(ThemePrefs.get(context.applicationContext))
    }
                    ...
                    Row(
                        ...
                        ThemePreference.entries.forEach { pref ->
                            FilterChip(
                                ...
                                onClick = {
                                    if (pref == themePreference) return@FilterChip
                                    themePreference = pref
                                    ThemePrefs.set(context.applicationContext, pref)
                                    ThemePrefs.applyToAppCompat(pref)
